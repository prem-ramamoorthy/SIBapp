    ...
    <div className="relative inline-block text-left">
      ...
      {open && (
        <div
          ...
          aria-modal="true"
          className="absolute right-0 z-50 mt-2 w-80 origin-top-right rounded-lg border border-gray-200 bg-white shadow-lg ring-1 ring-black/5 focus:outline-none "
        >
