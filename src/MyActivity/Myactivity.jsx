...
function MyActivity() {
  ...
  return (
    <div className="flex flex-col items-center justify-start w-full min-h-screen bg-stone-50 dark:bg-black/90 transition-colors duration-300">
      ...
      <main className="w-full max-w-7xl px-3 sm:px-6 md:px-10 text-gray-900 dark:text-gray-100 mt-20 sm:mt-24 pb-20 mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4 sticky top-24">
            ...
            <section className="w-full bg-white dark:bg-gray-900 rounded-2xl border border-stone-100 dark:border-gray-800 p-4 shadow-sm flex flex-col gap-3">
          ...
          {/* Right Column: Full activity list (filtered) */}
          <div className="lg:col-span-8 flex flex-col">
            <section className="w-full h-[calc(100vh-140px)]">
