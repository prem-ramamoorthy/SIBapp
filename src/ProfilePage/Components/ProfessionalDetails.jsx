...
const Chip = ({ children }) => (
  <span className="inline-flex items-center rounded-full border border-slate-200 bg-slate-50 px-2.5 py-1 text-xs font-medium text-slate-700 shadow-sm">
    {children}
  </span>
);
    ...
    <section className="w-full rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="mb-3 flex items-start justify-between">
        ...
        <button
          type="button"
          onClick={onEdit}
          className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1.5 text-sm font-medium text-amber-600 shadow-sm hover:bg-amber-50 focus:outline-none focus:ring-2 focus:ring-amber-500/40"
      ...
      <div className="my-2 h-px w-full bg-slate-200/70" />
      ...
      <div className="mb-4">
        ...
        <div className="space-y-2">
          <div className="rounded-md bg-sky-100 px-3 py-2 text-center text-sm font-semibold text-sky-800 ring-1 ring-inset ring-sky-200">
            {data.verticals[0]}
          </div>
          <div className="rounded-md bg-green-100 px-3 py-2 text-center text-sm font-semibold text-green-800 ring-1 ring-inset ring-green-200">
            {data.verticals[1]}
          </div>
        </div>
      </div>
