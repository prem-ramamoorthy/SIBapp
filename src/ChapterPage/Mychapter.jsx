...
function Meetings() {
    ...
    return (
        <div className="px-4">
            ...
            <div className="w-[98%] -m-2 mx-0 ml-2 mb-3 bg-white rounded-2xl h-fit border-1">
            ...
            <div className="mt-5 flex flex-col justify-around align-middle w-full">
            ...
            <div className="activity-container w-[98%] min-h-[330px] m-2 border-2 border-gray-400 bg-white rounded-2xl">
                <div>
                    <h1 className="my-3 pr-2 font-bold flex flex-row justify-around">
                        <p className="pl-4 flex justify-start w-full">Member Roster</p>
                        <Search />
                    </h1>
                </div>
