...
const TABLE_COLUMNS = [
    ...
    { key: 'tyftbGiven', label: 'TYB GIVEN SLIPS', sortable: true, width: 'w-20' },
    { key: 'tyftbReceived', label: 'TYB RECEIVED SLIPS', sortable: true, width: 'w-20' },
    { key: 'businessMade', label: 'TYB RECEIVED', sortable: true, width: 'w-24' },
    { key: 'businessGiven', label: 'TYB GIVEN', sortable: true, width: 'w-24' },
