    ...
    <div className="container flex flex-1 items-center justify-around">
      <div className="max-w-[87.5%] bg-white p-5 rounded-2xl flex flex-col gap-3 ">
        ...
        <div className="header flex gap-2 my-4 justify-between w-full">
          <button className="text-sm font-semibold border-b-4 border-gray-400 hover:border-amber-300 pb-2 mr-4">
            Register someone else (To visit my chapter)
          </button>
          <button className="text-sm font-semibold border-b-4 border-gray-400 hover:border-amber-300 pb-2">
        ...
        <div className="flex w-full gap-4">
          ...
          <EntryField type="tel" placeholder="Enter Phone Number" label="Phone Number" />
        </div>
