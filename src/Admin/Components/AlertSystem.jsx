        ...
        <div className="w-full lg:w-1/2 bg-white dark:bg-slate-900 rounded-xl sm:rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 overflow-hidden transition-all duration-300">
          ...
          <div className="p-5 sm:p-8 space-y-6 sm:space-y-8">
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center p-3 sm:p-4 rounded-xl border transition-all duration-200 ${
                      formData.alertType === type.id
                        ? `bg-white dark:bg-slate-800 ring-2 ring-offset-2 ring-offset-slate-50 dark:ring-offset-slate-900 ${type.border} ring-${type.color.split('-')[1]}-500 shadow-sm`
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-4">
              ...
              <button 
                type="button"
                className="flex-1 flex items-center justify-center gap-2.5 px-6 py-3.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-semibold shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/40 transition-all duration-200 transform hover:-translate-y-0.5"
              >
