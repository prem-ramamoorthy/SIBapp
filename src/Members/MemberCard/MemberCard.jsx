      ...
      <div className="relative bg-white dark:bg-gray-800 w-full rounded-2xl flex flex-col flex-1 shadow-md hover:shadow-xl transition-all duration-300 pb-4">
        ...
        <div className="px-4 pb-1">
          <div className="flex flex-row items-center w-full gap-2 pt-3 border-t border-gray-100 dark:border-gray-800">
            ...
            <NavLink
              to={link}
              className="flex-1 flex justify-center items-center h-[38px] bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-xl hover:opacity-90 transition-all duration-200 shadow-sm active:scale-95"
            >
              <span className="text-[11px] font-black uppercase tracking-wider">View Profile</span>
            </NavLink>
          </div>
        </div>
